...
const main = async () => {
  // Limpando o banco de dados antes de inserir novos dados
  ...
  // Criando categoria de combos
  const combosCategory = await prisma.menuCategory.create({
    data: {
      name: "Combos",
  ...
  // Criando produtos da categoria combos
  ...
  // Criando categoria de lanches
  const hamburguersCategory = await prisma.menuCategory.create({
    data: {
      name: "Lanches",
      restaurantId: restaurant.id,
    },
  ...
  // Criando produtos da categoria lanches
  await prisma.product.createMany({
    data: [
      {
        name: "Big Mac",
  ...
  // Criando categoria de fritas
  const frenchFriesCategory = await prisma.menuCategory.create({
    data: {
      name: "Fritas",
      restaurantId: restaurant.id,
    },
  ...
  // Criando produtos da categoria fritas
  await prisma.product.createMany({
    data: [
      {
        name: "Fritas Grande",
  ...
  // Criando produtos da categoria bebidas
  await prisma.product.createMany({
    data: [
      {
        name: "Coca-cola",
  ...
  // Criando categoria de sobremesas
  const desertsCategory = await prisma.menuCategory.create({
    data: {
      name: "Sobremesas",
      restaurantId: restaurant.id,
    },
  ...
  // Criando produtos da categoria sobremesas
  await prisma.product.createMany({
    data: [
      {
