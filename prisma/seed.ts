...
const main = async () => {
  ...
  const restaurant_41f762f7_ec11_45e2_b69d_20157fb15deb =
  ...
  const category_086eeab6_4e24_4fd8_bd9f_5f8ae945213b =
  ...
  const category_624c486d_52da_4b6b_b145_f7706f7426ae =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const category_93849142_233e_4464_b68b_ca8a35989372 =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const category_4145a4fb_2604_46c1_8c8e_4ad720d63a49 =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const category_ad25260e_fd06_48f0_8884_290774dec39b =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const restaurant_c0580798_24f3_43e2_8c2a_b0094d5ab349 =
    await prisma.restaurant.create({
      data: {
        ...
        avatarImageUrl:
          "https://img.freepik.com/vetores-premium/design-de-logotipo-de-churrasco-premium-moderno-simples-modelo-de-comida-ou-grelha_106546-1115.jpg?w=90",
        coverImageUrl:
          "https://pixabay.com/pt/photos/shish-kebab-espeto-de-carne-417994/",
  ...
  const category_98afe623_dade_45ba_828d_6e308616fbfa =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const category_7e6a278c_cbf0_419b_89f8_66ff533ec324 =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const restaurant_bfd1da9a_f015_4910_8305_e5d1be8ae339 =
    await prisma.restaurant.create({
      data: {
        ...
        avatarImageUrl:
          "https://img.cardapio.menu/storage/media/company_logo/27038858/conversions/logo.jpg",
  ...
  // Criando categoria: Lanches
  const category_b3b4d9b7_275d_4c22_bb60_9b92090a18ec =
    await prisma.menuCategory.create({
      data: {
        ...{
    ...
    data: [
      {
        ...{
          ...
          price: 12,
          imageUrl:
            "https://img.freepik.com/fotos-gratis/tacos-mexicanos-com-carne-legumes-e-cebola-vermelha_2829-8233.jpg?t=st=1740938499~exp=1740942099~hmac=3f5b4d93be877e3dff71fea0feb81c7a1bf538b454cd2657dbe256473f85d263&w=296",
          ingredients: [],
  ...
  const category_0a909ebd_3ab6_4169_af27_6bd3d9aa3f1f =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const category_b487c74e_c9b3_4166_ae88_0f4fc0cb2d41 =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  // Criando categoria: Fritas
  const category_4933186c_122c_449e_95cc_80a976caee96 =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const category_35e8981f_03f8_4662_9306_9069baeda065 =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  // Criando categoria: Combos
  const category_a3a4cad5_b52a_403f_a729_7ff11ded83e0 =
    await prisma.menuCategory.create({
      data: {
        ...{
  ...
  const category_eca346c6_bdb0_475a_9028_c463da711f22 =
    await prisma.menuCategory.create({
      data: {
        ...{
